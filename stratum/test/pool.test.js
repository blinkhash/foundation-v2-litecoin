...
describe('Test pool functionality', () => {
  ...
  test('Test pool manager setup [9]', (done) => {
    ...
    pool.on('pool.log', (type, text) => {
      if (type !== 'debug') {
        ...
        expect(text).toBe('Submitted a primary block (Litecoin:1) successfully to Litecoin\'s daemon instance(s)');
        done();
      }
    });
    mockSetupDaemons(pool, () => {
  ...
  test('Test pool workers handling [2]', () => {
    ...
    const expected = { 'na1CV4odThQ4mfzxQNhDbH4EN82bRukjq6': { 'generate': 0, 'immature': 20000 }};
  ...
  test('Test pool workers handling [3]', () => {
    ...
    const expected = {
      'na1CV4odThQ4mfzxQNhDbH4EN82bRukjq6': { 'immature': 5000, 'generate': 0 },
  ...
  test('Test pool workers handling [4]', () => {
    ...
    worker2.times = 49.1;
    const expected = {
      'na1CV4odThQ4mfzxQNhDbH4EN82bRukjq6': { 'immature': 8474.10994411, 'generate': 0 },
  ...
  test('Test pool workers handling [5]', () => {
    ...
    const expected = { 'na1CV4odThQ4mfzxQNhDbH4EN82bRukjq6': { 'generate': 10000, 'immature': 0 }};
    pool.handlePrimaryWorkers([blocks1], [[worker1]], false, (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [6]', () => {
    ...
    const expected = { 'na1CV4odThQ4mfzxQNhDbH4EN82bRukjq6': { 'immature': 0, 'generate': 20000 }};
    pool.handlePrimaryWorkers([blocks1, blocks1], [[worker1], [worker1]], false, (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [12]', () => {
    ...
    const expected = {
      'na1CV4odThQ4mfzxQNhDbH4EN82bRukjq6': { 'immature': 9570.0056964, 'generate': 0 },
      'na1CV4odThQ4mfzxQNhDbH4EN82bRukjq7': { 'immature': 429.9943036, 'generate': 0 }};
    pool.handlePrimaryWorkers([blocks1], [[worker1, worker2]], false, (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [14]', () => {
    ...
    const expected = { 'na1CV4odThQ4mfzxQNhDbH4EN82bRukjq6': { 'immature': -10000, 'generate': 10000 }};
    pool.handlePrimaryWorkers([blocks1], [[worker1]], true, (results) => {
      expect(results).toStrictEqual(expected);
    });
  });

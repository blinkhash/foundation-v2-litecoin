...
describe('Test pool functionality', () => {
  ...
  test('Test pool settings setup [2]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.setupSettings(() => {
        expect(configCopy.primary.address).toBe('ltc1qya20xua0rgq9jdteffkt83xr4aq082gruc2gry');
  ...
  test('Test pool settings setup [3]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      nock('http://127.0.0.1:9332')
        .post('/').reply(200, JSON.stringify([
          { id: 'nocktest', error: true, result: { isvalid: true, address: 'ltc1qya20xua0rgq9jdteffkt83xr4aq082gruc2gry' }},
          { id: 'nocktest', error: null, result: { networkhashps: 0 }},
          { id: 'nocktest', error: null, result: { chain: 'main', difficulty: 0 }},
          { id: 'nocktest', error: null, result: { protocolversion: 1, connections: 1 }},
        ]));
  ...
  test('Test pool settings setup [4]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      nock('http://127.0.0.1:9332')
        .post('/').reply(200, JSON.stringify([
          { id: 'nocktest', error: null, result: { isvalid: false, address: 'ltc1qya20xua0rgq9jdteffkt83xr4aq082gruc2gry' }},
          { id: 'nocktest', error: null, result: { networkhashps: 0 }},
          { id: 'nocktest', error: null, result: { chain: 'main', difficulty: 0 }},
          { id: 'nocktest', error: null, result: { protocolversion: 1, connections: 1 }},
        ]));
  ...
  test('Test pool block polling setup [1]', (done) => {
    ...
    pool.on('pool.log', (type, text) => {
      ...
      if (response.length === 2) {
        ...
        expect(response[1][1]).toBe('Requested template from primary chain (Litecoin:2) via RPC polling');
        done();
      }
    });
    mockSetupDaemons(pool, () => {
  ...
  test('Test pool block polling setup [2]', (done) => {
    ...
    pool.on('pool.log', (type, text) => {
      ...
      if (response.length === 3) {
        ...
        expect(response[2][1]).toBe('Requested template from primary chain (Litecoin:1) via RPC polling');
        done();
      }
    });
    mockSetupDaemons(pool, () => {
    ...
    mockSetupDaemons(pool, () => {
      nock('http://127.0.0.1:9332')
        ...
        .reply(200, JSON.stringify({
          id: 'nocktest',
          error: null,
          result: { isvalid: true, address: 'ltc1qya20xua0rgq9jdteffkt83xr4aq082gruc2gry' }
        }));
      pool.checkWorker(pool.primary.daemon, 'ltc1qya20xua0rgq9jdteffkt83xr4aq082gruc2gry', (valid) => {
  ...
  test('Test pool stratum authentication [2]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.checkWorker(pool.primary.daemon, 'ltc1qya20xua0rgq9jdteffkt83xr4aq082gruc2gry.worker1', (valid) => {
        expect(valid).toBe(true);
        done();
      });
    });
  ...
  test('Test pool stratum authentication [3]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.checkPrimaryWorker('0.0.0.0', 3001, 'ltc1qya20xua0rgq9jdteffkt83xr4aq082gruc2gry', (valid) => {
        expect(valid).toBe(true);
        done();
      });
    });
    ...
    mockSetupDaemons(pool, () => {
      nock('http://127.0.0.1:9332')
        ...
        .reply(200, JSON.stringify({
          id: 'nocktest',
          error: null,
          result: { isvalid: false, address: 'ltc1qya20xua0rgq9jdteffkt83xr4aq082gruc2gry' }
        }));
      pool.checkPrimaryWorker('0.0.0.0', 3001, 'ltc1qya20xua0rgq9jdteffkt83xr4aq082gruc2gry', () => {}, (result) => {
  ...
  test('Test pool stratum authentication [6]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.checkAuxiliaryWorker('0.0.0.0', 3001, 'ltc1qya20xua0rgq9jdteffkt83xr4aq082gruc2gry', (valid) => {
        expect(valid).toBe(true);
        done();
      });
    });
  ...
  test('Test pool stratum authentication [7]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.checkAuxiliaryWorker('0.0.0.0', 3001, 'ltc1qya20xua0rgq9jdteffkt83xr4aq082gruc2gry', () => {}, (result) => {
        expect(result).toStrictEqual({ 'error': null, 'authorized': false, 'disconnect': false });
        done();
      });
    });
  ...
  test('Test pool stratum authentication [10]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.authorizeWorker('0.0.0.0', 3001, 'ltc1qya20xua0rgq9jdteffkt83xr4aq082gruc2gry', null, 'test', (result) => {
  ...
  test('Test pool stratum authentication [11]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.authorizeWorker('0.0.0.0', 3001, 'ltc1qya20xua0rgq9jdteffkt83xr4aq082gruc2gry', 'ltc1qya20xua0rgq9jdteffkt83xr4aq082gruc2gry', 'test', (result) => {
        expect(result).toStrictEqual({ 'error': null, 'authorized': true, 'disconnect': false });
        done();
      });
    });
  ...
  test('Test pool workers handling [1]', () => {
    ...
    const expected = { 'na1CV4odThQ4mfzxQNhDbH4EN82bRukjq6_false_primary': { 'immature': 9999.996, 'generate': 0 }};
  ...
  test('Test pool workers handling [2]', () => {
    ...
    const expected = { 'na1CV4odThQ4mfzxQNhDbH4EN82bRukjq6_false_primary': { 'generate': 0, 'immature': 19999.992 }};
  ...
  test('Test pool workers handling [3]', () => {
    ...
    const expected = {
      'na1CV4odThQ4mfzxQNhDbH4EN82bRukjq6_false_primary': { 'immature': 4999.998, 'generate': 0 },
      'na1CV4odThQ4mfzxQNhDbH4EN82bRukjq7_false_primary': { 'immature': 4999.998, 'generate': 0 }};
  ...
  test('Test pool workers handling [4]', () => {
    ...
    worker2.times = 49.1;
    const expected = {
      'na1CV4odThQ4mfzxQNhDbH4EN82bRukjq6_false_primary': { 'immature': 8474.10655446, 'generate': 0 },
      'na1CV4odThQ4mfzxQNhDbH4EN82bRukjq7_false_primary': { 'immature': 1525.88944554, 'generate': 0 }};
    pool.handlePrimaryWorkers([blocks1], [[worker1, worker2]], (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [5]', () => {
    ...
    const expected = { 'na1CV4odThQ4mfzxQNhDbH4EN82bRukjq6_false_primary': { 'generate': 9999.996, 'immature': 0 }};
    pool.handlePrimaryWorkers([blocks1], [[worker1]], (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [6]', () => {
    ...
    const expected = { 'na1CV4odThQ4mfzxQNhDbH4EN82bRukjq6_false_primary': { 'immature': 0, 'generate': 19999.992 }};
    pool.handlePrimaryWorkers([blocks1, blocks1], [[worker1], [worker1]], (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [10]', () => {
    ...
    const expected = { 'na1CV4odThQ4mfzxQNhDbH4EN82bRukjq6_false_auxiliary': { 'immature': 9999.996, 'generate': 0 }};
  ...
  test('Test pool workers handling [11]', () => {
    ...
    const expected = { 'na1CV4odThQ4mfzxQNhDbH4EN82bRukjq6_false_auxiliary': { 'generate': 0, 'immature': 19999.992 }};
  ...
  test('Test pool workers handling [12]', () => {
    ...
    worker2.worker = 'na1CV4odThQ4mfzxQNhDbH4EN82bRukjq7.worker4';
    const expected = {
      'na1CV4odThQ4mfzxQNhDbH4EN82bRukjq6_false_auxiliary': { 'immature': 4999.998, 'generate': 0 },
      'na1CV4odThQ4mfzxQNhDbH4EN82bRukjq7_false_auxiliary': { 'immature': 4999.998, 'generate': 0 }};
  ...
  test('Test pool workers handling [13]', () => {
    ...
    worker2.times = 49.1;
    const expected = {
      'na1CV4odThQ4mfzxQNhDbH4EN82bRukjq6_false_auxiliary': { 'immature': 8474.10655446, 'generate': 0 },
      'na1CV4odThQ4mfzxQNhDbH4EN82bRukjq7_false_auxiliary': { 'immature': 1525.88944554, 'generate': 0 }};
    pool.handleAuxiliaryWorkers([blocks1], [[worker1, worker2]], (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [14]', () => {
    ...
    const expected = { 'na1CV4odThQ4mfzxQNhDbH4EN82bRukjq6_false_auxiliary': { 'generate': 9999.996, 'immature': 0 }};
    pool.handleAuxiliaryWorkers([blocks1], [[worker1]], (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [15]', () => {
    ...
    const expected = { 'na1CV4odThQ4mfzxQNhDbH4EN82bRukjq6_false_auxiliary': { 'immature': 0, 'generate': 19999.992 }};
    pool.handleAuxiliaryWorkers([blocks1, blocks1], [[worker1], [worker1]], (results) => {
      expect(results).toStrictEqual(expected);
    });
  });

...
describe('Test template functionality', () => {
  ...
  test('Test generation transaction handling', () => {
    ...
    expect(template.generation[1]).toStrictEqual(Buffer.from('000000000200f2052a010000001600142754f373af1a005935794a6cb3c4c3af40f3a9030000000000000000266a24aa21a9ede2f61c3f71d1defd3fa999dfa36953755c690689799962b48bebd836974e8cf900000000', 'hex'));
  });
  ...
  test('Test coinbase serialization [1]', () => {
    ...
    expect(coinbase.slice(51)).toStrictEqual(Buffer.from('000000000200f2052a010000001600142754f373af1a005935794a6cb3c4c3af40f3a9030000000000000000266a24aa21a9ede2f61c3f71d1defd3fa999dfa36953755c690689799962b48bebd836974e8cf900000000', 'hex'));
  });
  ...
  test('Test block serialization [1]', () => {
    ...
    expect(templateHex).toStrictEqual(Buffer.from('', 'hex'));
  });
